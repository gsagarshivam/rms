...
$sql="update tblleaves set DepartmentRemark=:description,department_status=:status,DepartmentDate=:admremarkdate where id=:did";
$query = $dbh->prepare($sql);
...
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
$msg="Leave updated By Department Head Successfully";
}
...
{         
      ...
      <tr>
          <td style="font-size:16px;"><b>Department Leave Status :</b></td>
          <td colspan="5"><?php $department_status=$result->department_status;
            if($department_status==1){
            ?>
              <span style="color: green">Approved</span>
            <?php } if($department_status==2)  { ?>
              <span style="color: red">Not Approved</span>
            <?php } if($department_status==0)  { ?>
        ...
        <tr>
          <td style="font-size:16px;"><b>Department Remark: </b></td>
          <td colspan="5"><?php
          if($result->DepartmentRemark  ==""){
            echo "waiting for Approval";  
          }
          else{
          echo htmlentities($result->DepartmentRemark );
          }
          ?></td>
        </tr>

        <tr>
          <td style="font-size:16px;"><b>Department Action taken date : </b></td>
          <td colspan="5"><?php
          if($result->DepartmentDate==""){
            echo "NA";  
          }
          else{
          echo htmlentities($result->DepartmentDate);
          }
          ?></td>
        </tr>
        ...
        <tr>
           <td colspan="2">
              <a class="modal-trigger waves-effect waves-light btn" href="#moda2">Department Take&nbsp;Action</a>
              <form name="adminaction" method="post">
                <div id="moda2" class="modal modal-fixed-footer" style="height: 60%">
                  <div class="modal-content" style="width:90%">
                    <h4>Leave take action</h4>
                      <select class="browser-default" name="department_status" required="">
                  ...
                  <div class="modal-footer" style="width:90%">
                    <input type="submit" class="waves-effect waves-light btn blue m-b-xs" name="department" value="Submit"/>
                  </div>
                </div> 
              </form>     
           </td>
        ...
        ?>
           ...
           <td colspan="2">
              <a class="modal-trigger waves-effect waves-light btn" href="#modal1">Admin Take&nbsp;Action</a>
              <form name="adminaction" method="post">
