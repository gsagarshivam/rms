                ...
                <div class="side-nav-wrapper">
                    <div class="sidebar-profile">
                        <div class="sidebar-profile-image">
                            <img style="width: 100px; height: 100px; margin-left: 36px;" src="../assets/images/logo.png" class="circle" alt="">
                        </div>
                        <div class="sidebar-profile-info">
                       
                                <p style="margin-left: 54px; color: rgba(0,0,0,.54)">Hii Admin</p>
